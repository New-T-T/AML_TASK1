...
ESTIMATORS = [
    ...
    ('svr', LinearSVR(random_state=42)),                   #not converging
    ('xgb', XGBRegressor()),
...
BEST_ESTIMATORS = [
    ...
    ('cat,', CatBoostRegressor(depth=6,learning_rate=0.1,l2_leaf_reg=0.1)),
...
GS_PARAMS_SPLIT = [
    ...
    ('bay_ridge', {'n_iter':[300,600,900], 'alpha_1':[1e-07,1e-06,1e-05],'alpha_2':[1e-07,1e-06,1e-05],'lambda_1':[1e-07,1e-06,1e-05],'lambda_2':[1e-07,1e-06,1e-05]}),
    ('kernel_ridge', {})
]
...
class StackedRegressor():
    ...
    def gridsearchseperate(self,x_data,y_data):
        ...
        file1 = open("data/best_params.txt", "w")  # write mode
